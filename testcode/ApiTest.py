...
# URL 생성
url = f"http://www.aladin.co.kr/ttb/api/ItemList.aspx?ttbkey={ttbkey}&QueryType={QueryType}&MaxResults={MaxResults}&start=1&SearchTarget=Book&output=JS&Version=20131101"
